    ...
    public class GestoraPersonajeConTransformacionesYHabilidadesBL
    {
        ...
        {            
            ...
            try
            {
                ...
                listadoPersonajeConTransformacionesYHabilidades = await gestoraPersonajeConTransformacionesYHabilidadesDAL.getListaPersonajeConTransformacionesYHabilidades();
            }
            catch (Exception e)
            {
                throw e;
